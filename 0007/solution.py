...
def day_barn_becomes_empty(n: int, m: int) -> int:
    """
    Determine by the end of which day the barn will become empty for the first time.
    
    Args:
        n: Capacity of the barn (1 ≤ n ≤ 10^18)
        m: Number of grains brought every day (1 ≤ m ≤ 10^18)
        
    Returns:
        The day number when the barn becomes empty for the first time
    """
    pass
