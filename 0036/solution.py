...
def coordinates_after_n_moves(n: int) -> tuple:
    """
    Determine the coordinates after n moves in the hexagonal spiral.
    
    Args:
        n: Number of moves (0 ≤ n ≤ 10^18)
        
    Returns:
        Tuple (x, y) representing the coordinates after n moves
    """
    pass
