...
def seconds_until_lunch(seat: str) -> int:
    """
    Calculate how many seconds Vasya has to wait until he gets his lunch.
    
    Args:
        seat: String in the format ns, where n (1 ≤ n ≤ 10^18) is the row number
             and s is the seat letter ('a' to 'f')
