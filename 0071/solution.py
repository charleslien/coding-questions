...
def calculate_question_distribution(n: int, m: int, k: int, x: int, y: int) -> tuple:
    """
    Calculate the distribution of questions asked by the teacher.
    
    Args:
        n: Number of rows in the class (1 ≤ n ≤ 100)
        m: Number of pupils in each row (1 ≤ m ≤ 100)
        k: Number of questions asked (1 ≤ k ≤ 10^18)
        x: Sergei's row (1 ≤ x ≤ n)
        y: Sergei's place in the row (1 ≤ y ≤ m)
        
    Returns:
        Tuple (max_questions, min_questions, sergei_questions) where:
        - max_questions: Maximum number of questions a particular pupil is asked
        - min_questions: Minimum number of questions a particular pupil is asked
        - sergei_questions: Number of times the teacher asked Sergei
    """
    pass
