...
def max_odd_sum_subsequence(n: int, sequence: list) -> int:
    """
    Find the maximum sum of a subsequence with odd sum.
    
    Args:
        n: Length of the sequence (1 ≤ n ≤ 10^5)
        sequence: List of n integers (-10^4 ≤ a_i ≤ 10^4)
        
    Returns:
        Maximum sum of a subsequence with odd sum
    """
    pass
