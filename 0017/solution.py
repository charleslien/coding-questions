...
def standing_spectators(n: int, k: int, t: int) -> int:
    """
    Calculate how many spectators are standing at time t during the Mexican wave.
    
    Args:
        n: Number of spectators in the stadium (1 ≤ n ≤ 10^9)
        k: Parameter determining when spectators sit down (1 ≤ k ≤ n)
        t: Time at which to count standing spectators (1 ≤ t < n + k)
