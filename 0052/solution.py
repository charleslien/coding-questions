...
def possible_team_counts(n: int) -> list:
    """
    Determine how many teams Daniel should invite to have exactly n games in the tournament.
    
    Args:
        n: Number of games that should be played (1 ≤ n ≤ 10^18)
        
    Returns:
        List of possible numbers of teams in ascending order, or [-1] if there are no such numbers
    """
    pass
