...
def determine_game_winner(n: int, sequence: list) -> str:
    """
    Determine who wins the Bitlandish game if both players play optimally.
    
    Args:
        n: Number of integers in the sequence (1 ≤ n ≤ 3)
        sequence: List of n non-negative integers (0 ≤ a_i < 300)
        
    Returns:
        "BitLGM" if BitLGM wins, "BitAryo" if BitAryo wins
    """
    pass
