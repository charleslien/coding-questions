...
def min_marks_to_add(n: int, k: int, marks: list) -> int:
    """
    Calculate the minimal number of additional marks needed to get a final mark of k.
    
    Args:
        n: Number of marks received by Noora (1 ≤ n ≤ 100)
        k: Highest possible mark (1 ≤ k ≤ 100)
        marks: List of n integers representing Noora's current marks (1 ≤ a_i ≤ k)
        
    Returns:
        Minimal number of additional marks needed
    """
    pass
