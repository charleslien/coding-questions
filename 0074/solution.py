...
def represent_as_sum_of_primes(n: int) -> tuple:
    """
    Represent an odd number as the sum of at most three primes.
    
    Args:
        n: An odd number (3 ≤ n < 10^9)
        
    Returns:
        Tuple (k, primes), where:
        - k: Number of primes in the representation (1 ≤ k ≤ 3)
        - primes: List of k prime numbers that sum to n
    """
    pass
