...
def are_tracks_coinciding(n: int, L: int, kefa_barriers: list, sasha_barriers: list) -> str:
    """
    Check if Kefa's and Sasha's tracks coincide.
    
    Args:
        n: Number of barriers on the track (1 ≤ n ≤ 50)
        L: Length of the track (n ≤ L ≤ 100)
        kefa_barriers: List of n distinct integers representing distances from Kefa's start
                      to each barrier (0 ≤ barrier ≤ L-1)
        sasha_barriers: List of n distinct integers representing distances from Sasha's start
                       to each barrier (0 ≤ barrier ≤ L-1)
