...
def count_pairs_divisible_by_5(n: int, m: int) -> int:
    """
    Count the number of pairs (x, y) such that 1 ≤ x ≤ n, 1 ≤ y ≤ m and (x + y) is divisible by 5.
    
    Args:
        n: Upper limit for x (1 ≤ n ≤ 1,000,000)
        m: Upper limit for y (1 ≤ m ≤ 1,000,000)
        
    Returns:
        Number of pairs (x, y) such that (x + y) is divisible by 5
    """
    pass
