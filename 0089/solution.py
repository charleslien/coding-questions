...
def min_layers_for_segments(N: int) -> int:
    """
    Calculate the minimal number of layers required to draw all segments without overlapping.
    
    Args:
        N: Integer defining the coordinate range (1 ≤ N ≤ 100)
        
    Returns:
        Minimal number of layers required
    """
    pass
